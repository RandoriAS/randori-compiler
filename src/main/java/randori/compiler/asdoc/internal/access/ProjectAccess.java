...
import randori.compiler.asdoc.internal.definitions.SkinPartDefinition;
import randori.compiler.asdoc.internal.definitions.SkinStateDefinition;
import randori.compiler.asdoc.visitor.ASWalker;
import randori.compiler.asdoc.visitor.IASVisitor;
import randori.compiler.asdoc.visitor.IASWalker;
...
public class ProjectAccess implements IASProjectAccess
{
    ...
    private Map<String, List<IFunctionDefinition>> functions = new HashMap<String, List<IFunctionDefinition>>();
    ...
    public ProjectAccess(IFlexProject project)
    {
    ...
    // @Override
    public void setSourceFileNames(List<String> sourceFiles)
    {
            ...
            String namespace)
    {
        ...
        if (!functions.containsKey(definition.getQualifiedName()))
            return result;

        for (IFunctionDefinition member : functions.get(definition
                .getQualifiedName()))
        {
    ...
    public void addFunction(IFunctionDefinition definition)
    {
        ...
        List<IFunctionDefinition> list = functions.get(parent
                .getQualifiedName());
        if (list == null)
        {
            list = new ArrayList<IFunctionDefinition>();
            functions.put(parent.getQualifiedName(), list);
        }
