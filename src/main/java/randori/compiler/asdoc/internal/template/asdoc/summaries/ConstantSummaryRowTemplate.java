...
public class ConstantSummaryRowTemplate extends SummaryRowTemplate
{
    // --------------------------------------------------------------------------
    //
    // Public :: Constants
    ...
    public static final String TEMPLATE_FILE = "summary/constant-summary-row.vm";

    /**
     * Constructor.
     */
    public ConstantSummaryRowTemplate(IDocConfiguration config)
    {
        super(config);
