 ...
 * @since 1.0
 */
public class SkinStateSummaryRowTemplate extends SummaryRowTemplate
{
    // --------------------------------------------------------------------------
    //
    // Public :: Constants
    ...
    public static final String TEMPLATE_FILE = "summary/skinstate-summary-row.vm";
     ...
     * Constructor.
     */
    public SkinStateSummaryRowTemplate(IDocConfiguration config)
    {
        super(config);
    ...
    {
        ISkinStateDefinition state = (ISkinStateDefinition) getDefinition();
