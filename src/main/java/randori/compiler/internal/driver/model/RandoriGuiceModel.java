 ...
 */
public class RandoriGuiceModel extends BaseCompilationSet
{
    private static final String RANDORI_GUICEJS = "RandoriGuice.js";
    ...
    public void generate(IRandoriBackend backend, File output)
    {
        ...
        writeFull(libraryPath, RANDORI_GUICEJS);
    }
}
