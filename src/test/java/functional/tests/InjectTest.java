...
public class InjectTest extends FunctionalTestBase
{
    ...
    public void test_file()
    {
        ...
        assertOut("if (typeof demo == \"undefined\")\n\tvar demo = {};\nif "
                ...
                + "\n\ndemo.inject.InjectTest = function(param1, param2) {"
                ...
                + "{\n\treturn null;\n};\n\ndemo.inject.InjectTest.prototype.set_injectAccessor "
                + "= function(value) {\n};\n\ndemo.inject.InjectTest.prototype.injectMethod = "
                + "function(param1, param2) {\n\tif (arguments.length < 2) {\n\t\tparam2 = "
                + "\"foo\";\n\t}\n};\n\ndemo.inject.InjectTest.className = \"demo.inject."
                ...
                + "break;\n\t\tcase 2:\n\t\t\tp = [];\n\t\t\tp.push({n:'injectMethod', "
                + "p:[{n:'param1', t:'demo.foo.ClassB'}, {n:'param2'}]});\n\t\t\tbreak;\n\t\t"
                + "case 3:\n\t\t\tp = [];\n\t\t\tp.push({n:'viewField'});\n\t\t\tbreak;\n\t\t"
                + "default:\n\t\t\tp = [];\n\t\t\tbreak;\n\t}\n\treturn p;\n};\n\n");
    }
